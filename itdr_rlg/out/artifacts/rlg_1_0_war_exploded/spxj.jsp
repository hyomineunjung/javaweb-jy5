...
<div id="zs">
    <input type="text" name="uid" placeholder="请输入您要下架的商品的id" id="srk" style="width: 200px;height: 30px">
    <input type="button" value="下架" id="fjen">
    <div id="nrhz"></div>
</div>
