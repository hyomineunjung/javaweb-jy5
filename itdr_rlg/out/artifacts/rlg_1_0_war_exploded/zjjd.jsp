...
<div id="zs">
    <input type="text" name="id" placeholder="请输入您要增加的节点的id" id="srk1" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
    <input type="text" name="pname" placeholder="请输入您要增加的节点的父id" id="srk2" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
    <input type="text" name="status" placeholder="请输入您要增加的节点的名称" id="srk3" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
    <input type="text" name="categoryId" placeholder="请输入您要增加的节点的状态" id="srk4" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
    <input type="text" name="price" placeholder="请输入您要增加的节点的其他信息" id="srk5" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
...
<script>
    ...
    $("#fjen").click(function () {
        var id=$("#srk1").val();
        var parentId=$("#srk2").val();
        var name=$("#srk3").val();
        var status=$("#srk4").val();
        var sortorder=$("#srk5").val();
        $.post(
            "/manage/category/add_category.do",

            {id:id,parentId:parentId,name:name,status:status,sortorder:sortorder},
            function (dt) {
                if (dt.status!==400){
                    $("#nrhz").empty();
                    ...
                    $("#nrhz").empty();
                    alert("您已增加"+dt.data+"个节点")
                    window.open("syjd.jsp");
                    window.opener=null;
                    window.open('','_self');
                    window.close();
                }
