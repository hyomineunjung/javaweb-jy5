...
<div id="zs">
    <input type="text" name="uid" placeholder="请输入您要发货的订单的id" id="srk" style="width: 200px;height: 30px">
    <input type="button" value="发货" id="fjen">
    <div id="nrhz"></div>
</div>
