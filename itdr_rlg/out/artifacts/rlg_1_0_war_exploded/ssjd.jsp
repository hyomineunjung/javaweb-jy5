...
<div id="zs">
    <input type="text" name="uid" placeholder="请输入您要搜索的节点的id" id="srk" style="width: 200px;height: 30px">
            ...
            function (dt) {
                if (dt.status !== 400) {
                    ...
                    for (var i = 0; i < dt.data.length; i++) {
                        var s="<tr><td>" + dt.data[i].id + "</td><td>" + dt.data[i].parentId + "</td><td>" + dt.data[i].name + "</td><td>" + dt.data[i].status + "</td><td>" + dt.data[i].sortorder + "</td></tr>";
                        $("#tab").append(s)
                    }
                }
            },
