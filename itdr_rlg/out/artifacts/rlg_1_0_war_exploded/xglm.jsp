...
<div id="zs">
    <input type="text" name="uid" placeholder="请输入您要修改的类名id" id="srk1" style="width: 200px;height: 30px">
    <input type="text" name="uid" placeholder="请输入您要修改的类名id" id="srk2" style="width: 200px;height: 30px">
    <input type="button" value="封禁" id="fjen">
    <div id="nrhz"></div>
</div>
