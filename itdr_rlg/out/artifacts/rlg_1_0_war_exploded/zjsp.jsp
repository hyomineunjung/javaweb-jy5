...
<div id="zs">
    <input type="text" name="id" placeholder="请输入您要增加的商品的id" id="srk1" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
    <input type="text" name="pname" placeholder="请输入您要增加的商品的名称" id="srk2" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
    <input type="text" name="status" placeholder="请输入您要增加的商品的状态" id="srk3" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
    <input type="text" name="categoryId" placeholder="请输入您要增加的商品的父id" id="srk4" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
    <input type="text" name="price" placeholder="请输入您要增加的商品的价格" id="srk5" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
    <input type="text" name="cuxiao" placeholder="请输入您要增加的商品的打折情况" id="srk6" style="width: 200px;height: 30px;border: 1px black solid">
    <br>
    <input type="button" value="增加" id="fjen">
    <div id="nrhz"></div>
</div>
...
<script>
    ...
    $("#fjen").click(function () {
        ...
        var pname=$("#srk2").val();
        var status=$("#srk3").val();
        var categoryId=$("#srk4").val();
        var price=$("#srk5").val();
        var cuxiao=$("#srk6").val();
        $.post(
            "/manage/product/add.do",

            {id:id,pname:pname,status:status,categoryId:categoryId,price:price,cuxiao:cuxiao},
            function (dt) {
                if (dt.status!==200){
                    $("#nrhz").empty();
                    ...
                    $("#nrhz").empty();
                    alert("您已增加"+dt.data+"个商品")
                    window.open("shangpinliebiao.jsp");
                    window.opener=null;
                    window.open('','_self');
                    window.close();
                }
