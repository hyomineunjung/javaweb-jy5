...
<div id="zs">
    <input type="text" name="uid" placeholder="请输入您要搜索的订单的id" id="srk" style="width: 200px;height: 30px">
        ...
        $.post(
            ...
            function (dt) {
                if (dt.status !== 300) {
                    ...
                    $("#nrhz").empty();
                    var s = "<tr><td>" + dt.data.spid + "</td><td>" + dt.data.zfje + "</td><td>" + dt.data.zfzt + "</td><td>" + dt.data.zffs + "</td><td>" + dt.data.ddzt + "</td></tr>";
                    $("#tab").append(s);
                }
            }
        )
