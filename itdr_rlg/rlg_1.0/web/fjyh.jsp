...
<div id="zs">
    <input type="text" name="uid" placeholder="请输入您要封禁的用户id" id="srk" style="width: 200px;height: 30px">
        ...
        $.post(
            ...
            function (dt) {
                if (dt.status!==100){
                    ...
                    $("#nrhz").empty();
                    // $("#nrhz").append();
                    alert("您已封禁"+dt.data+"名用户");
                    window.open("huoquyonghuliebiao.jsp");
                    window.opener=null;
                    window.open('','_self');
                    window.close();
                }
